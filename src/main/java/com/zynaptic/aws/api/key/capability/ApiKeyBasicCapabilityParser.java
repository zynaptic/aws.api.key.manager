...
public class ApiKeyBasicCapabilityParser implements ApiKeyCapabilityParser {
      ...
      while (jsonNodeIter.hasNext()) {
        ...
        if (attributeValue != null) {
          if (attributeValue.isTextual()) {
            ...
            capabilityDataMap.put(attributeKey, Double.valueOf(attributeValue.asDouble()));
          }
        }
      }
   ...
   * invalid number formats are forced to zero for consistency with the JSON based
   * constructor.
   */
  @Override
      ...
      for (Map.Entry<String, AttributeValue> attributeMapEntry : attributeMap.entrySet()) {
        ...
        if (attributeValue != null) {
          if (attributeValue.getS() != null) {
            ...
            try {
              capabilityDataMap.put(attributeKey, Double.valueOf(attributeValue.getN()));
            } catch (NumberFormatException error) {
              capabilityDataMap.put(attributeKey, Double.valueOf(0));
            }
          }
        }
      }
